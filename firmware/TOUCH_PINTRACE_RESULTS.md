...
Resume by restoring a working USB serial connection (try another cable or
USB socket), then capture another five-target run. Do not treat this USB
failure as evidence about the resistive touch circuit.
