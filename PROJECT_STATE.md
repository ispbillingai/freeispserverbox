...
- **Horn placement and mount:** body envelope X = -124..-22, Y = -25.5..79.5, Z = 8..110 (mouth face at Y79.5, 2 mm behind the switch cradle; 7 mm under the cap roof).  `FIR_Shell.horn_floor_mount()` builds three 14 mm x 5 mm floor pads on the measured isosceles triangle with 3.4 mm M4 self-tap pilots 6 mm deep - deep enough to hold, short enough not to break the 3 mm floor.  Measured clearances: **1.0 mm** to the cap side-bolt bosses that stand 12 mm off the -X wall, 2.0 mm to the brain case, 2.0 mm to the switch cradle.  **Not measured:** how far back the bracket foot's centre sits from the mouth face.  `HORN_FOOT_FROM_MOUTH = 99.0` is an assumption, the three pads follow it, and both scripts say so every run.
